...
//            String accessToken = request.getHeader(UrlConstant.TOKEN);
//            if (CommonUtil.isNotNullEmpty(accessToken)) {
//                String userCode = redisService.getUserId(accessToken);
//                //登录超时
//                if (!CommonUtil.isNotNullEmpty(userCode)) {
//                    ApiResult result = new ApiResult(20, UrlConstant.TIMT_OUT, null, null);
